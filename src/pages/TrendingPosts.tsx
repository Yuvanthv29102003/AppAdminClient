...
export const TrendingPosts: FC = () => {
  ...
  const [selectedItems, setSelectedItems] = useState<TrendingPostData[]>([]);
  const itemsPerPage = 10;

  // For now, using all data without filtering since search input was removed
  const filteredData = mockTrendingPosts;
  ...
  const handleCheckboxChange = (checkedItems: TrendingPostData[]) => {
